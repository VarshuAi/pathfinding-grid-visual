...
<!-- VARSHUOS-THEME-END -->
<!-- ========================================================================= -->
<!--                        PATHFINDING-GRID-VISUAL — README                            -->
...
<img src="https://capsule-render.vercel.app/api?type=soft&color=a8e6cf,dcedc1,ffd3b6&height=180&section=header&text=pathfinding-grid-visual&fontSize=48&fontColor=ffffff&fontAlignY=38&animation=fadeIn" width="100%"/>

<!-- ============================== TYPING SVG ============================== -->

<br/>

<a href="https://github.com/VarshuAi/pathfinding-grid-visual"><img src="https://readme-typing-svg.demolab.com?font=Comfortaa&weight=500&size=22&duration=3500&pause=800&color=2E7D32&center=true&vCenter=true&multiline=true&repeat=true&random=false&width=700&height=80&lines=%F0%9F%8C%BF%20Growing%20Green%20Software...;%F0%9F%8D%83%20Clean%20%E2%80%A2%20Sustainable%20%E2%80%A2%20Pure;%E2%98%80%EF%B8%8F%20Powered%20by%20Nature" alt="Typing SVG"/></a>
...
```yaml
name: pathfinding-grid-visual
version: 1.0
type: Repository
author: VarshuAi
description: >
  name: pathfinding-grid-visual version: 1.0 type: Repository author: VarshuAi description: >   name: pathfinding-grid-visual version: 1.0 type: Repository author: VarshuAi description: >   name: pathfinding-grid-visual version: 1.0 type: Repository author: VarshuAi description: >   name: pathfinding-grid-visual version: 1.0 type: Repository author: VarshuAi description: >   name: pathfinding-grid-visual version: 1.0 type: Repository author: VarshuAi description: >   name: pathfinding-grid-visual version: 1.0 type: Repository author: VarshuAi description: >   Visualizer showing pathfinding vectors navigating barriers. primary_tech: CSS primary_tech: CSS primary_tech: CSS primary_tech: CSS primary_tech: CSS primary_tech: CSS
primary_tech: CSS
```
...
git clone https://github.com/VarshuAi/pathfinding-grid-visual.git
cd pathfinding-grid-visual
```
...
<a href="https://github.com/VarshuAi/pathfinding-grid-visual"><img src="https://img.shields.io/badge/pathfinding-grid-visual-Repo-2E7D32?style=for-the-badge&logo=github&logoColor=black" alt="Repository"/></a>
